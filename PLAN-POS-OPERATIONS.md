...
| Assign Rooms to Order · Assign Pieces                                                     | Line details: room, pieces (piece count for the truck; §13 serial tracking still excluded)                                                                                                                               |
...
| Enter a Discount on Multiple Lines · Group Pricing                                        | One dialog: pick lines, $ per line or % of price; writes line discounts (price-variance controls apply)                                                                                                                  |
...
| Line Comments                                                                             | Line details: comment                                                                                                                                                                                                    |
...
| Price / Spiff / Commission Table                                                          | Per-line commission at the salesperson's plan rate (basis per §9); spiffs are not modeled — the column prints —                                                                                                          |
...
| Split Merchandise Lines                                                                   | Order split (exists) + split one line's quantity into two lines                                                                                                                                                          |
