...
Strip above every role home. Header: "{Month} competition · 6 races · $100 each · win 4 → $1,000 · 5 → $1,500 · all 6 → $2,000", days-left chip (22px & navy in last 48h), sweep chip once anyone leads ≥3 cards, + Log lead, Collapse. Six cards (links to leaderboard): title, $100, **everyone who competes** (rank, name, store code, value, secondary small) — ranked rows first, then the people the race cannot rank yet with "—" for a number and muted; collapsed keeps the top three — pace line (grey leader, navy you, tick = leader at today's rate; expanded only), **pinned own row** (accent-soft) with gap in metric units ("$349 behind Brandon"), one-line rule. Footer: completed orders only · returns within 30 days come off · ties by net sales · bonus tiers replace the $100s · prizes pay on the 5th · History.
*Amendment 2026-09-13 (owner):* people only — the People | Stores toggle, the Stores race, its prizes, the store winner column and the stores line on the banner and sheet are gone. Everyone whose role can log a lead (Manager, Cashier by default) is on every card from day one, sales or not, not just the top three; the Owner role is off the board entirely (no card row, no pinned row, ledger sales not counted).
