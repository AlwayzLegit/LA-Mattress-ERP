...
*Amendment 2026-09-13 (owner):* people only — the People | Stores toggle, the Stores race, its prizes, the store winner column and the stores line on the banner and sheet are gone. Everyone whose role can log a lead (Owner, Manager, Cashier by default) is on every card from day one, sales or not, not just the top three.
