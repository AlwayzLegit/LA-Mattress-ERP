...
export function pinoHttpOptions(): Options {
  return {
    ...
    // With wrapSerializers disabled, explicitly keep request/response objects compact.
    // Raw Node objects contain rawHeaders and nested req/res cycles outside redaction paths.
    serializers: {
